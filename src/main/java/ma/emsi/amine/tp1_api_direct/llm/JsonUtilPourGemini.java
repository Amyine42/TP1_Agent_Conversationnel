package ma.emsi.amine.tp1_api_direct.llm;
...
import ma.emsi.amine.tp1_api_direct.exceptions.RequeteException;
...
public class JsonUtilPourGemini implements Serializable {
     ...
     * @ throws RequeteExeption exception lancée dans le cas où la requête a été rejetée par l'API.
     */
